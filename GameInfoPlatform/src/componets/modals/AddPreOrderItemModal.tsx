...
export default function AddPreOrderItemModal() {
        ...
        <View style={styles.modalBackground}>
          <View style={styles.modalStyle}>
            <View>
              ...
              <View style={styles.subTitle}>
                <Icon name={'stopwatch'} size={15} color={'#E4E4E4'} />
                <Text style={styles.subTitleText}>截訂日期</Text>
              </View>
              <View style={styles.modalItemBox}>
                <Text style={styles.updateItemText}>2023年7月3日</Text>
              </View>
