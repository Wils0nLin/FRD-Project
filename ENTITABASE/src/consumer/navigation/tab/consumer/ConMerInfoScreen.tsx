...
export default function ConMerInfoScreen() {
  ...
  const getData = async () => {
    const resp = await fetch(`http://10.0.2.2:3000/consumer/shopInfo/2`, {
      method: 'GET',
  ...
  const getItemData = async () => {
    const resp = await fetch(`http://10.0.2.2:3000/merchant/allItem/2`, {
      method: 'GET',
      headers: {'Content-Type': 'application/json'},
    });
    const data = await resp.json();
  ...
  const getCommentData = async () => {
    const resp = await fetch(`http://10.0.2.2:3000/merchant/comment/2`, {
      method: 'GET',
      headers: {'Content-Type': 'application/json'},
    });
    const data = await resp.json();
