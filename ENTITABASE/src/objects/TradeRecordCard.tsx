...
export default function TradeRecordCard(props: cardInfo) {
  return (
    <View style={styles.screenCardBackground}>
      <View style={styles.screenCardLine} />
      <View style={styles.screenCardImage}>
        <FontAwesome5 name={'receipt'} size={25} color={'#E4E4E4'} solid />
      </View>
      <View style={{flex: 1, marginLeft: 10}}>
        ...
        <View style={styles.screenLine1}>
          ...
          <Text style={styles.screenCardText1}>共 {props.order} 件商品</Text>
        </View>
