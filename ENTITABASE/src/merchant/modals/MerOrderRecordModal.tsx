...
import PreOrderRecordCard from '../../objects/PreOrderRecordCard';
...
export default function MerOrderRecordModal(props: any) {
          ...
          <View style={styles.modalStyle}>
            <View>
              ...
              <TouchableOpacity style={styles.modalUpdateName}>
                <Text style={styles.updateNameText}>{props.consumer}</Text>
              </TouchableOpacity>
              ...
              <View style={{marginBottom: 5}}>
                <View style={styles.modalItemBox}>
                  <Text style={styles.orderItemText}>{props.name}</Text>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <FontAwesome5 name={'times'} size={10} color={'#E4E4E4'} />
                    <Text style={styles.orderInfoText}>1</Text>
                  </View>
                  <Text style={styles.orderInfoText}>{props.amount}.00</Text>
                </View>
